...
export default function BadgesPage() {
    ...
    return (
        <div className="min-h-screen bg-[#F5F5F7] dark:bg-black text-[#1d1d1f] dark:text-[#F5F5F7] font-sans selection:bg-blue-200 dark:selection:bg-blue-900/50 flex flex-col items-center overflow-x-hidden">
            {/* Background Effects */}
            ...
            <div className="w-full max-w-5xl px-4 sm:px-8 py-6 md:py-8 z-10 flex flex-col min-h-screen animate-fade-in relative">
                ...
                <header className="flex justify-between items-center mb-10 pb-4 border-b border-black/5 dark:border-white/10">
                    <Link href="/dashboard" className="flex items-center gap-2 group text-[#1d1d1f] dark:text-white hover:opacity-70 transition-opacity">
                ...
                <main className="flex flex-col gap-8 pb-20">
                    ...
                    <div className="flex flex-col items-center text-center mb-4">
                        ...
                        <h1 className="text-4xl md:text-5xl font-black tracking-tight mb-4 bg-gradient-to-b from-[#1d1d1f] to-[#1d1d1f]/60 dark:from-white dark:to-white/60 bg-clip-text text-transparent">
                            Bộ sưu tập Huy hiệu
                        </h1>
                        <p className="text-slate-500 dark:text-slate-400 max-w-lg text-[16px] font-medium leading-relaxed">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                        <div className="bg-white dark:bg-[#1d1d1f] p-6 rounded-[28px] shadow-sm ring-1 ring-black/5 dark:ring-white/5 flex flex-col items-center">
