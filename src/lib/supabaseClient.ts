...
export async function getLiveStreamEquipment() {
    ...
    return [
        ...
        { id: 18, group: 'Light Stands', brand: 'OEM', gearList: 'Black', quantity: 2, serialNumber: '', source: 'VDK', status: 'Good', checked: false },
        { id: 19, group: 'Light Stands', brand: 'OEM', gearList: 'Chrome', quantity: 1, serialNumber: '', source: 'VDK', status: 'Good', checked: false },
        { id: 20, group: 'Light Stands', brand: 'OEM', gearList: 'Chrome', quantity: 1, serialNumber: '', source: 'Trainer', status: 'Good', checked: false },
        { id: 21, group: 'Tripod', brand: 'Benro', gearList: 'KH26', quantity: 3, serialNumber: '', source: 'VDK', status: 'Good', checked: false },
        { id: 22, group: 'Microphone', brand: 'Sony', gearList: 'C80', quantity: 1, serialNumber: '', source: 'DI-MKT', status: 'Good', checked: false },
        { id: 23, group: 'Camera', brand: 'Sony', gearList: '', quantity: 1, serialNumber: '', source: 'DI-MKT', status: 'Good', checked: false },
        { id: 24, group: 'Camera', brand: 'Sony', gearList: '', quantity: 1, serialNumber: '', source: 'DI-MKT', status: 'Good', checked: false },
        { id: 25, group: 'Lens', brand: 'Sony', gearList: '', quantity: 1, serialNumber: '', source: 'DI-MKT', status: 'Good', checked: false }
    ];
}
