...
export default function ColorLab({ section = 'profile', onNavigateSection }) {
    const LUT_FILES = [
        "TH_Nordic_Greens_LUT_x33.cube",
        "Don_Autumn.cube",
        "Denis-BarbasxSony-ARCTIC.cube",
        "TH_Street_Tones_LUT_x33.cube",
        "Neutral_Slog3_LUT.cube",
        "EV_GOLD+OVER+BLUE_NAZARE_LUT.cube",
        "OPPENHEIMER.cube",
        "JOKER.cube",
        "Shot_by_Alice_Sony_LUT-DUSK.cube",
        "Shot_by_Alice_Sony_LUT-DAWN.cube",
        "Shot_by_Alice_Sony_LUT-FERN.cube",
        "Denis-BarbasxSony-WINTERFELL.cube",
        "Chicago_Slog3_LUT.cube",
        "FOREST_SLOG3_27.RAS-FX6-2111.cube",
        "TH_Studio_Mood_LUT_x33.cube",
        "The_Creator.cube",
        "EV_IMMERSIVE_BLUE_IRELAND_LUT.cube",
        "SonyProSW-LUT2_REC709.cube",
        "Christmas-Sony-Slog-3-Alex-Don.cube",
        "GLACIERS_SLOG3_6.RAS-FX6-3517.cube",
        "SonyProSW-LUT1_REC709.cube",
        "DESERTS_SLOG3_8.RAS-FX6-0071.cube",
        "Halloween-0.cube",
        "Batman.cube",
        "Denis-BarbasxSony-BLIZZARD.cube",
        "SonyProSW-LUT3_REC709.cube",
        "EV_PURPLE_HAZE_AFRICA_LUT.cube",
        "Halloween2.cube",
        "EV_DREAMALITY_AFRICA_LUT.cube",
        "C&W_SLOG3_16.REST_4220.cube"
    ];
    ...
    const [subTab, setSubTab] = useState(section); // 'creative', 'profile', 'lut'
    ...
    const handleRecipeSelect = (recipe) => {
        ...
        trackClientAction('color_profile_views');
    };
    ...
    const handleTabSwitch = (tab) => {
        ...
        if (tab === 'creative') {
            trackClientAction('creative_look_views');
        }
    };

    const trackLutDownload = () => {
        trackClientAction('lut_downloads');
    };
